...
class VCSMC:
    ...
    def resample(self, core, leafnode_num_record, JC_K, log_weights, llh_sum):
        ...
        log_normalized_weights = 30 * log_normalized_weights
        log_normalized_weights = log_normalized_weights - tf.reduce_logsumexp(log_normalized_weights)
...
# #         print(data.shape)
    ...
    def train(self, epochs=100, batch_size=128, learning_rate=0.001, memory_optimization='on'):
        ...
        for i in tqdm(range(epochs)):
            ...
            print(f'prior_constant: {np.round(pc,3)}')
